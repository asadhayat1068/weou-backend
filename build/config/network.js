...
exports.updateSecrets = exports.SECRET_WALLET = exports.SECRET_TRANSACTION = exports.OPENSEA_API_KEY = exports.COLLECTION_ADDRESS = exports.wss_provider = exports.networkConfig = void 0;
...
const updateSecrets = () => {
    exports.SECRET_TRANSACTION = Math.floor(Math.random() * 256).toString(16);
    exports.SECRET_WALLET = Math.floor(Math.random() * 256).toString(16);
};
